#Harga_ayam = input("Masukkan harga ayam: ")
#Harga_daging = input("Masukkan harga daging: ")

#print(f"--- Total: Rp{(2 * int(Harga_ayam)) + int(Harga_daging)} ---")


#Harga_Daging = 45000
#Beli_Daging = int(input("Masukkan jumlah daging yang dibeli: "))
#Total harga daging: Rp{Beli_Daging * Harga_1Kg_Daging}
#if Beli_Daging == 2:
